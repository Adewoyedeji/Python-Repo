...
# If you run the program multiple times in testing
# or with dfferent files, make sure to empty out the data before each run.
#
...
# as each record is read in the loop,
...
#
# The program can be speeded up greatly
# by moving the commit operation outside of the loop.
# In any database program, there is a balance between the number of operations
# you execute between commits and the importance of
